# Règles — Autres documents (VISA, DC4)
...
4. L'identification du **sous-traitant**
5. La mention de **l'objet du marché**
6. La mention de la **nature des travaux sous-traités**

### Validité métier
1. Être **signée par le professionnel titulaire** avec nom, prénom et fonction du signataire
2. Mentionner le **SIRET du sous-traitant**
3. Être **cohérente avec les documents du marché** (numéro d'engagement et/ou objet du marché identique)

### Règles diverses
1. Pour que la DC4 puisse valider le certificat RGE d'un sous-traitant → la **nature des travaux** doit être précise et **cohérente avec la fiche valorisée**.
